...
<div class="col-75">
<div class="container">
<form method="post" action="BusBillpdf.php">
<div class="row">
<div class="col-50">
...
if(isset($_POST['book'])) {
 ...
 $bus_id = $_POST['Bus_id'];
 $sql = "select fare from Bus_Available where Bus_id='$bus_id'" ;
...
$cvv=$_POST['cvv'];
$fare=$_POST['fare1'];
$sql = "insert into Bus_booked(Name,email,address,city,state,zip,NameOnCard,CardNumber,ExpMonth,ExpYear,cvv,fare)VALUES('$name','$email','$address','$city','$state','$zip','$NameOnCard','$cardnumber','$ExpMonth','$ExpYear','$cvv','$fare')";
