...
<font color="#2e86c1"><h1>ADD TRAIN IN TIMETABLE</h1></font>
<table border="2">
<form method="post" action="">
<tr><th>Train Id:</th><th><input type="text"  name="train_id"><br /><br></th></tr>
<tr><th>Train Name:</th><th><input type="text" name="train_name"><br /><br></th></tr>
...
$sql = "insert into Train_Available(train_id,train_name,leaving_from,going_to,depart_date,time,Return_Date,dest_time,fare)VALUES($tid,'$tname','$lefrom','$gto','$ddate','$time','$reto','$dest_time','$fare')";
