...
<font color="#2e86c1"><h1>ADD BUS IN TIMETABLE</h1></font>
<table border="2">
<form method="post" action="">
<tr><th>Bus_id:</th><th><input type="text"  name="Bus_id"><br /><br></th></tr>
<tr><th>Bus Name:</th><th><input type="text" name="Bus_name"><br /><br></th></tr>
...
$sql = "insert into Bus_Available(Bus_id,Bus_name,leaving_from,going_to,depart_date,time,Return_Date,dest_time,fare)VALUES($bid,'$bname','$lefrom','$gto','$ddate','$time','$reto','$dest_time','$fare')";
