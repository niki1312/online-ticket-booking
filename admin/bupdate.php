...
<font color="#c0392b"><h1>Enter the BusId which record can be update</h1></font>
<form method="post">
...
$sql = "UPDATE Bus_Available SET depart_date='$ddate',Return_Date='$rdate' WHERE Bus_id = '$bid'" ;
