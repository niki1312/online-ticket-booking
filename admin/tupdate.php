...
<font color="#c0392b"><h1>Enter the TrainId which record can be update</h1></font>
<form method="post">
...
$sql = "UPDATE Train_Available SET depart_date='$ddate',Return_Date='$rdate' WHERE train_id = '$bid'" ;
