...
<body>
<form action="Bbooked.php" method="post">
<?php
...
<tr><th><label for="Bus_id">BusId</th><td><input type="text" name="Bus_id" placeholder="Enter the Bus id"></td</tr>
...
<tr><th>Email Id<span class="required">*</span></th><td><input type:"text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  placeholder="Type your Email Address" required></td></tr>
